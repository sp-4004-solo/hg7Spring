...
$(function(){
	...
	$("#checkAll").click(function(){
		if($("#checkAll").is(":checked") ) $("input[name=agree]").prop("checked", true);
				...
				<div id="member">
					...
					<div class="agreeWrap">
						...
						<p>본 약관은 2005년 5월 16일부터 시행합니다.</p>
							...
							<ul>
								<li class="chk">
									<input type="checkbox" id="agree1" name="agree" /><label for="agree1">이용약관에 동의합니다.</label>
								</li>
								<li class="btn">
						...
						<h4>3. 개인정보의 보유 및 이용기간</h4>
							...
							<ul>
								<li class="chk">
									<input type="checkbox" id="agree2" name="agree" /><label for="agree2">개인정보 보호를 위한 이용자 <span>동의사항에 동의합니다.</span></label>
								</li>
								<li class="btn">
									<a href="#" class="nbtnMini">전체보기</a>
								</li>
						...
						<h4>3. 개인정보의 보유 및 이용기간</h4>
							...
							<ul class="fn">
								<li class="chk">
									<input type="checkbox" id="agree3" name="agree" /><label for="agree3">개인정보 보호를 위한 이용자 <span>동의사항에 동의합니다.</span></label>
								</li>
								<li class="btn">
									<a href="#" class="nbtnMini">전체보기</a>
								</li>
					...
					<li class="chk">
					 <input type="checkbox" id="checkAll" /><label for="checkAll">전체동의</span></label>
					</li>

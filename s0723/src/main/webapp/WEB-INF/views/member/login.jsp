...
$(function(){
	$("#loginBtn").click(function(){
     ...
     $.ajax({
    	url:"/member/ajaxLogin",//주소(데이터 베이스)
    	method:"post",
    	data:{"id":id,"pw":pw},//아이디로 넘어가면
    	dataType:"text",
    	success:function(data){
    		...
    		console.log(data);
    			if(data =="1"){
    				...
    				alert("아이디또는 패스워드가 틀립니다. 다시 입력하세요");
    				$("#pw").val("");//패스워드 삭제
    				$("#pw").focus();
    			}
    	},
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								...
								<li> <!-- pw -->
									<input type="password" id="pw" name="pw" class="passType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" />
								</li>
							</ul>
